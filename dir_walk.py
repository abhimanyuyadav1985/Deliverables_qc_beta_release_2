...
if __name__ == "__main__":
    ...
    parser.add_argument("-xf", "--exclude_folder", nargs='*', help="exclude folder", default=['.git','source','.idea','dist','sqlite','Reports'])
    parser.add_argument("-xn", "--exclude_name", nargs='*', help="exclude name", default=['.pyc'])
